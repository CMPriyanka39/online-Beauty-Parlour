...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/tq.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-no-pb">
		...
		<h5 style="color='black'">Your Appointment no is sent to Your email..please verify it :) </h5>
        </div>
    	</div>
