...
if (strlen($_SESSION['bpmsaid']==0)) {
  ...
  $aname=$_POST['username'];
     ...
     $query=mysqli_query($con, "update users set user_name ='$aname',name='$name' where ID='$id'");
    if ($query) {
	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Users Profile</h3>
...
$ret=mysqli_query($con,"select * from tblusers where ID='$usersid'");
$cnt=1;
